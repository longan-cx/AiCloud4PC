...
CFileItemUI::CFileItemUI()
{
}


CFileItemUI::~CFileItemUI(void)
{
	if(m_hIcon != NULL)
		::DestroyIcon(m_hIcon);
}

void CFileItemUI::DoEvent(DuiLib::TEventUI& event)
{
...
void CFileItemUI::PaintStatusImage(HDC hDC)
{
...
void CFileItemUI::SetIcon(HICON hIcon)
{
	m_hIcon = hIcon;
}
